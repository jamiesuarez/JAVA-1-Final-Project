...
public class Choice {
       ...
       *
       * @param choice input 0 for random 1 to choose 2 for story
      ...
      public Human human(int choice,
            ...
            System.out.println("\nInput 1 to Select Lady\nInput 2 to Select Cowboy\nInput 3 to Select Bandit\n"+ "Input 4 to Select Indian");
                 System.out.println("============================");
...
        * @param list_places list of implemented places
      ...
      public void mode(ArrayList<ArrayList<ArrayList<Human>>> list, Places[] list_places) {
            ...
            String input;
            do {
                  System.out.println("\nInput 1 for Random Mode" + "\nInput 2 for Select Mode" + "\nInput 3 for Story Mode" + "\nInput 4 to Exit");
                  System.out.println("============================");
                  System.out.println("Input: ");
                  input = scanner.nextLine();
                  int choice;
